...
CREATE TABLE IF NOT EXISTS users (
    id INT AUTO_INCREMENT PRIMARY KEY COMMENT '唯一标识每个用户的自增主键',
...
CREATE TABLE IF NOT EXISTS check_in_tasks (
    id INT AUTO_INCREMENT PRIMARY KEY COMMENT '唯一标识每个任务的自增主键',
...
CREATE TABLE IF NOT EXISTS check_ins (
    id INT AUTO_INCREMENT PRIMARY KEY COMMENT '打卡记录的唯一标识',
...
CREATE TABLE IF NOT EXISTS point_records (
    id INT AUTO_INCREMENT PRIMARY KEY COMMENT '积分记录的唯一标识',
    user_id INT NOT NULL COMMENT '关联用户表的外键',
